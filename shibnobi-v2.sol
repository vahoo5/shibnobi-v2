...
contract Shibnobi is ERC20, Ownable {
    ...
    constructor() ERC20("Shibnobi", "SHINJA") {
        ...
        marketingFeeAddress = payable(
            0x4Fb76696aEAaDEd4A93C1E4A25a69e7b6645a122
        );
        stakingFeeAddress = payable(0xe1B918219c7380583Dfda9D17f3A548032149ff5);

        minLpBeforeSwapping = 10;
    ...
    function migrateBridge(address newAddress) external onlyOwner {
        require(newAddress != address(0) && !automatedMarketMakerPairs[newAddress], "Can't set this address");
